...
class GastoController
{
    ...
    public function listarGastosPaginados($pagina, $limite)
    {
        $offset = ($pagina - 1) * $limite;
        return $this->gastoModel->obtenerGastosPaginados($limite, $offset);
    }

    public function contarTotalGastos()
    {
        return $this->gastoModel->contarTotalGastos();
    }
}
